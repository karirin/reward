//
//  RewardRegistrationCopyView.swift
//  reward
//
...
struct RewardRegistrationCopyView: View {
  ...
  @EnvironmentObject private var authManager: AuthManager
    ...
    init(reward: Reward) {
        ...
        self._content = State(initialValue: reward.content)
        self._url = State(initialValue: reward.url ?? "")
    }
...
struct RewardRegistrationCopyView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        RewardRegistrationCopyView(reward: dummyReward)
    }
}
